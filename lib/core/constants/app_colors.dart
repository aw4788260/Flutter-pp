...
class AppColors {
  ...
  static const Color backgroundPrimary = Color(0xFF242624);   // bg-background-primary
  static const Color backgroundSecondary = Color(0xFF343834); // bg-background-secondary
